...
class PlannersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planner" do
    assert_difference('Planner.count') do
      post planners_url, params: { planner: { name: @planner.name, photo_url: @planner.photo_url } }
    end
  ...
  test "should update planner" do
    patch planner_url(@planner), params: { planner: { name: @planner.name, photo_url: @planner.photo_url } }
